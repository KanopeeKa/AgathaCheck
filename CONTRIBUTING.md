...
- Flutter analyze, format, and parallel domain test shards (`pet-core`, `pet-screens`, `pet-widgets`, `health`, `rest-a`, `rest-b`, `experience`, `pet-care`) + merged domain coverage
