...
- **Chip/ID Reminder**: If a pet has no microchip ID and the user hasn't dismissed the reminder, a reminder card appears on the pet detail screen explaining that chipping is a legal requirement. User can "Snooze" or dismiss with "I don't want to chip / identify my pet" (sets `chipDismissed = true`).
