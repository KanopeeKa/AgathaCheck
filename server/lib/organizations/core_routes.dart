  ...
  final orgUuid = Uuid();
    router.get('/', (Request request) async {
      ...
      try {
        ...
        return Response.internalServerError(body: jsonEncode({'error': publicError(e, 'Error fetching organizations')}), headers: orgJsonHeaders);
      }
    });
    ...
    router.get('/<id>', (Request request, String id) async {
      ...
      try {
        ...
        if (results.isEmpty) {
          return Response.notFound(jsonEncode({'error': 'Organization not found'}), headers: orgJsonHeaders);
        }
        return Response.ok(jsonEncode(orgRowToMap(results.first)), headers: orgJsonHeaders);
      } catch (e) {
    ...
    router.post('/', (Request request) async {
      ...
      try {
        ...
        return Response(201, body: jsonEncode(orgRowToMap(results.first)), headers: orgJsonHeaders);
      } catch (e) {
        return Response.internalServerError(body: jsonEncode({'error': publicError(e, 'Error creating org')}), headers: orgJsonHeaders);
      }
    });
    ...
    router.delete('/<id>', (Request request, String id) async {
      ...
      try {
        ...
        return Response.ok(jsonEncode({'deleted': true}), headers: orgJsonHeaders);
      } catch (e) {
        return Response.internalServerError(body: jsonEncode({'error': publicError(e)}), headers: orgJsonHeaders);
      }
    });
