const MESSAGES = {
  en: {
    ...
    externalFosterNotice: {
      ...
      why: 'Agatha Track is used by rescues and charities to manage foster placements, reminders, and care records. Your details are visible only to administrators of that organisation. You may ask the organisation to stop outreach at any time.',
    ...
    externalProspectNotice: {
      subject: '{orgName} added you as an adoption prospect on Agatha Track',
      preheader: 'Your contact details are stored to help coordinate adoption visits.',
      title: 'Adoption prospect information',
      intro: '<strong>{orgName}</strong> has added your contact details to Agatha Track to help coordinate adoption visits and screening.',
      why: 'Agatha Track is used by rescues and charities to manage adoption visits and adopter screening. Your details are visible only to administrators of that organisation. You may ask the organisation to stop outreach at any time.',
      rights: 'You can learn how your data is used, how long it is kept, and exercise your privacy rights in our <a href="{url}" style="color:#1565C0;">Privacy Notice</a>. To request access, correction, deletion, or to opt out of further outreach, contact the organisation or email contact@agathatrack.com.',
      contact: 'If you believe this was added in error, please contact the organisation directly.',
      cta: 'Privacy Notice',
      textIntro: '{orgName} has added your contact details to Agatha Track to help coordinate adoption visits and screening.',
      textWhy: 'Your details are visible only to administrators of that organisation. You may ask the organisation to stop outreach at any time.',
      textRights: 'Privacy information, retention, and your rights (including opt-out): {url}',
      textContact: 'Questions? Contact the organisation or contact@agathatrack.com.',
    },
  ...
  fr: {
    ...
    externalFosterNotice: {
      ...
      why: 'Agatha Track est utilisé par des refuges et associations pour gérer les placements en famille d\'accueil. Vos coordonnées ne sont visibles que par les administrateurs de cette organisation. Vous pouvez demander à l\'organisation de cesser tout contact.',
    ...
    externalProspectNotice: {
      subject: '{orgName} vous a ajouté comme prospect d\'adoption sur Agatha Track',
      preheader: 'Vos coordonnées sont conservées pour faciliter les visites d\'adoption.',
      title: 'Coordonnées prospect d\'adoption',
      intro: '<strong>{orgName}</strong> a ajouté vos coordonnées sur Agatha Track pour faciliter les visites d\'adoption et le screening.',
      why: 'Agatha Track est utilisé par des refuges et associations pour gérer les visites d\'adoption. Vos coordonnées ne sont visibles que par les administrateurs de cette organisation. Vous pouvez demander à l\'organisation de cesser tout contact.',
      rights: 'Consultez notre <a href="{url}" style="color:#1565C0;">Politique de confidentialité</a> pour connaître la durée de conservation et vos droits. Pour exercer vos droits ou refuser tout contact ultérieur, contactez l\'organisation ou contact@agathatrack.com.',
      contact: 'Si vous pensez qu\'il s\'agit d\'une erreur, contactez directement l\'organisation.',
      cta: 'Politique de confidentialité',
      textIntro: '{orgName} a ajouté vos coordonnées sur Agatha Track pour faciliter les visites d\'adoption et le screening.',
      textWhy: 'Vos coordonnées ne sont visibles que par les administrateurs de cette organisation. Vous pouvez demander à l\'organisation de cesser tout contact.',
      textRights: 'Informations, conservation et droits (y compris opposition) : {url}',
      textContact: 'Questions ? Contactez l\'organisation ou contact@agathatrack.com.',
    },
