...
/**
 * Art. 14 informational email when an organisation adds a prospect contact.
 */
export function buildExternalProspectNoticeEmail({
  locale = 'en',
  orgName,
  privacyUrl,
}) {
  const lang = normalizeLocale(locale);
  const strings = getEmailStrings(lang, 'externalProspectNotice');
