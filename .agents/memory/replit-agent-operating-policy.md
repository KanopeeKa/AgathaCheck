...
Treat repo docs as source of truth, in this order: replit.md → .cursor/rules + AGENTS.md → README/docs → code. Inspect first, change second; smallest safe change; surface conflicts instead of improvising.
