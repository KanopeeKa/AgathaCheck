...
Extracted from [/docs/org-fostering-strategy.md](/docs/org-fostering-strategy.md). Custody **data model** (guardianship vs care) lives in the [organization domain](/docs/domains/organization/features/org-custody-model.md).
