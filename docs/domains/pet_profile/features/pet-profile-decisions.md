...
| ID | Decision | Status | Phase |
|----|----------|--------|-------|
| **D34** | Pet Care `/pc/home` remains exactly three management sections: **My Pets**, **Due and Overdue**, and **Veterinary team** (user-facing label; vet routes unchanged). **Today** is a compact orientation/prioritisation layer above them, not a fourth section, management screen, or new route. | locked | Phase 2 |
