...
> **Docs reorg (2026-08):** Cross-cutting rows live in [/docs/debt/deferred.md](/docs/debt/deferred.md). Domain-scoped items live in `docs/domains/<domain>/changes/deferred.md`. This file is a **legacy index pointer** — add new deferrals to the appropriate domain or cross-cutting file, not here.
...
| Scope | File |
|-------|------|
| Platform-wide (observability, GDPR, CI) | [/docs/debt/deferred.md](/docs/debt/deferred.md) |
| Product domain | `docs/domains/<domain>/changes/deferred.md` |
| Refactoring / modularization uncertainty | [/docs/debt/refactoring-debt.md](/docs/debt/refactoring-debt.md) |
...
| Observability architecture doc | `docs/ops/observability.md` |
