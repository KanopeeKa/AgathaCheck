...
**Legacy index:** [/docs/debt/technical-debt.md](/docs/debt/technical-debt.md) (being split) · [/docs/debt/refactoring-debt.md](/docs/debt/refactoring-debt.md)
...
| Item | Priority | Effort | Notes |
|------|----------|--------|-------|
| Document PostHog env vars in deploy runbook | P2 | Trivial | See `docs/ops/observability.md` |
