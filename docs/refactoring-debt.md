...
**Related:** [/docs/deferred.md](/docs/deferred.md) (cross-cutting) · [/docs/technical-debt.md](/docs/technical-debt.md) (legacy pointer) · `docs/architecture/modularity.md` (rules)
...
See [/docs/refactoring-log.md](/docs/refactoring-log.md) for sprint-level history. Domain deferred tables hold open items per area.
