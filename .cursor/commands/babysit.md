...
**Babysit+ only (after merge to `main`):** spawn a non-blocking UAT babysit sub-agent per `.cursor/skills/babysit-plus/SKILL.md` §8; main work continues unless the sub-agent reports a prod-ready failure.
