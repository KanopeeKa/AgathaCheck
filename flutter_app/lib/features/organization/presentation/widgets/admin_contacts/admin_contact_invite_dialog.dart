...
/// Invite a new admin contact (admin or super_admin roles only).
Future<void> showAdminContactInviteDialog({
  ...
  await showDialog<void>(
    ...
    builder: (ctx) => StatefulBuilder(
      builder: (ctx, setState) => AlertDialog(
        title: Text(l.adminContactsAddAdmin),
        content: Form(
          key: formKey,
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                key: const Key('admin_contact_invite_email'),
        ...
        actions: [
          ...
          FilledButton(
            key: const Key('admin_contact_invite_send'),
            onPressed: () async {
