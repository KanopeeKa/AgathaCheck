...
abstract final class PetCareDashboardDecoAssets {
...
abstract final class PetCareDashboardDecoThresholds {
...
PetCarePetRailDecoMode? petCarePetRailDecoModeForLeftover(double leftover) {
  if (leftover < PetCareDashboardDecoThresholds.railMinLeftover) {
    return null;
  }
  if (leftover >= PetCareDashboardDecoThresholds.railFullComposition) {
    return PetCarePetRailDecoMode.full;
  }
  if (leftover >= PetCareDashboardDecoThresholds.railCatAndBall) {
    return PetCarePetRailDecoMode.catAndBall;
  }
  return PetCarePetRailDecoMode.catOnly;
}
...
class PetCareDashboardAmbientDeco extends StatelessWidget {
  const PetCareDashboardAmbientDeco({
    super.key,
    required this.child,
    this.opacity = PetCareDashboardDecoThresholds.opacity,
  });
...
class PetCarePetRailYarnDeco extends StatelessWidget {
  const PetCarePetRailYarnDeco({
    super.key,
    required this.mode,
    required this.width,
  ...
  final PetCarePetRailDecoMode mode;
  final double width;
  final double height;
  ...
  @override
  Widget build(BuildContext context) {
    final compositionHeight = PetCareDashboardDecoThresholds.compositionHeight;
  ...
  Widget _compositionRow(double compositionHeight) {
    ...
    return Row(
      ...
      children: [
        _endCap(
          PetCareDashboardDecoAssets.cat,
          compositionHeight * _catAspect,
          compositionHeight,
        ),
        if (mode == PetCarePetRailDecoMode.full) ...[
          Expanded(
            child: Padding(
              ...
              child: Image.asset(
                PetCareDashboardDecoAssets.yarnSegment,
                height: yarnHeight,
                fit: BoxFit.fitWidth,
          ...
          _endCap(
            PetCareDashboardDecoAssets.yarnBall,
            compositionHeight * _ballAspect,
            compositionHeight,
          ),
        ] else if (mode == PetCarePetRailDecoMode.catAndBall) ...[
          const Spacer(),
          _endCap(
            PetCareDashboardDecoAssets.yarnBall,
            compositionHeight * _ballAspect,
...
double petCarePetRailContentWidth({
