...
class PetCareNavigationRail extends ConsumerWidget {
  const PetCareNavigationRail({super.key, required this.currentLocation});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Semantics(
      ...
      container: true,
      child: SizedBox(
        key: const Key('pet_care_navigation_rail'),
        width: width,
        child: NavigationRail(
          ...
          leading: Padding(
            ...
            child: Column(
              ...
              children: [
                Semantics(
                  identifier: 'pet_care_navigation_rail_brand',
                  label: l.appTitle,
                  child: AppLogoTitle(
                    title: l.appTitle,
          ...
          onDestinationSelected: (index) =>
              context.go(PetCarePrimaryDestinations.routes[index]),
          destinations: [
