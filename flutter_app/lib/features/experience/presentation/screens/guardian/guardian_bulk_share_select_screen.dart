...
import '../../widgets/guardian_pets_tile_grid.dart';
import '../../../domain/entities/app_experience.dart';
import '../guardian/guardian_bulk_share.dart';
import '../guardian/guardian_dashboard_helpers.dart';

/// Multi-select screen for bulk-sharing owned guardian pets.
class GuardianBulkShareSelectScreen extends ConsumerStatefulWidget {
  const GuardianBulkShareSelectScreen({super.key});

  @override
  ConsumerState<GuardianBulkShareSelectScreen> createState() =>
      _GuardianBulkShareSelectScreenState();
}

class _GuardianBulkShareSelectScreenState
    extends ConsumerState<GuardianBulkShareSelectScreen> {
  final _controller = PetListController();
  final _selectedPetIds = <String>{};

  List<Pet> _eligiblePets(List<Pet> allPets) {
    return guardianDashboardPersonalPets(allPets, _controller);
  }
