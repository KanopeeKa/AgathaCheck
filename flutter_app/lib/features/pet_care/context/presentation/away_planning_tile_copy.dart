...
class AwayPlanningTileCopy {
  ...
  static String resolve(AppLocalizations l, AwayPlanTileCopy c) => switch (c.copyKey) {
    'awayPlanningTileCarerNone' => l.awayPlanningTileCarerNone,
    'awayPlanningTileCarerSome' => l.awayPlanningTileCarerSome,
    'careContextCoverageNothingScheduled' => l.careContextCoverageNothingScheduled,
    ...
    'careContextCoverageHasItemsToReview' => l.careContextCoverageHasItemsToReview(c.copyParams?['count'] ?? 0),
