...
class _PendingAdoptionPlacementsSection extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              ...placements.map(
                (placement) => _PendingAdoptionPlacementCard(placement: placement),
              ),
            ],
          ),
        );
...
class _PendingAdoptionPlacementCard extends ConsumerWidget {
  const _PendingAdoptionPlacementCard({required this.placement});
