...
//
// Imported by pet_care_due_events_screen_test.dart and
...
import 'package:pet_profile_app/features/experience/presentation/screens/pet_care/add_event_type_picker_sheet.dart';
...
export 'package:pet_profile_app/features/experience/presentation/screens/pet_care/pet_care_due_events_screen.dart';
...
/// [PetCareDueEventsScreen] with a pet-provider that errors — tests pet-load
/// error recovery UI.
Widget buildScreenWithPetError() {
  return ProviderScope(
    ...
    child: MaterialApp(
      ...
      localizationsDelegates: AppLocalizations.localizationsDelegates,
      supportedLocales: AppLocalizations.supportedLocales,
      home: const Scaffold(body: PetCareDueEventsScreen()),
    ),
  );
}
