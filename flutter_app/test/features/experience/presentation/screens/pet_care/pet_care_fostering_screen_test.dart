...
import 'package:pet_profile_app/features/experience/presentation/screens/pet_care/pet_care_fostering_screen.dart';
import 'package:pet_profile_app/features/experience/presentation/widgets/experience_shell_scaffold.dart';
import 'package:pet_profile_app/features/experience/presentation/widgets/pet_care_fostering_section.dart';
...
void main() {
  ...
  testWidgets('shows loading indicator while pets load', (tester) async {
    ...
    expect(find.byType(PetCareFosteringSection), findsNothing);
  });
  ...
  testWidgets('renders fostering section with loaded pets', (tester) async {
    ...
    expect(find.byType(PetCareFosteringSection), findsOneWidget);
