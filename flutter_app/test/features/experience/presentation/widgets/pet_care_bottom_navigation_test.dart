...
void main() {
  ...
  group('PetCareBottomNavigation', () {
    ...
    test('recognises Guardian workspace routes', () {
      ...
      expect(PetCareBottomNavigation.supports('/o/orgs'), isFalse);
    });

    test('only uses the mobile bar below the compact breakpoint', () {
      expect(PetCareBottomNavigation.isCompact(599), isTrue);
      expect(PetCareBottomNavigation.isCompact(600), isFalse);
      expect(PetCareBottomNavigation.isCompact(1280), isFalse);
    });
  });
