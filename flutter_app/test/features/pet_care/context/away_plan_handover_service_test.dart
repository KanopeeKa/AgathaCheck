...
void main() {
  test('handover note is passed to PDF verbatim (D-AWAY-008)', () {
    ...
    expect(
      AwayPlanHandoverService.handoverNoteForPdf(verbatimNote),
      verbatimNote,
    );
  ...
  test(
    'generateHandoverPdf renders a per-pet document with pet_note and a '
    'trip-wide note title without error',
    () async {
